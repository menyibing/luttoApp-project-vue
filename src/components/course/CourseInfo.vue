     ...
     <div class="comment">
       <div class="all_comment">
         ...
         <div class="big_gray">
           ...
           <button type="button" class="button " data-toggle="modal" data-target="#myModal" @click="addcomment">发表评论
           </button>
         </div>
         ...
         <div v-if="show" class="every_comment" :data-comment-id="comment.id" v-for="comment in comment_list">
           ...
           <div class="float">
             ...
             <div class="zan" id="zan" @click="likecomment">
               <img id="hand" src="../../assets/course/未点赞.svg" v-if="!comment.like_flag" alt=""
                    style="width: 20px;height: 20px">
               <img id="hand1" src="../../assets/course/赞.svg" v-if="comment.like_flag" alt=""
                    style="width: 20px;height: 20px">
             ...
             <transition name="fade">
              <span class="kuang"  v-show="replymark == comment.id">
              <textarea cols="110" rows="4" class="small_publish" id="small_publish" placeholder="在这里输入内容..."></textarea><br>
                <button type="button" class="button " data-toggle="modal" data-target="#myModal" @click="replyComment">回复</button>
              </span>
             </transition>
           ...
           <div class="all_huifu">
             <div class="huifu" v-for="reply in  comment.commnetreply">
               <div class="line_height">
                 ...
                 <span class="small_info">{{reply.content}}</span>
                 <span class="small_time">({{reply.time}})</span>
