  ...
  <div class="container">
    ...
    <div class="row title">
      ...
      <div class="col-md-6  font-color-grey">
        <!--<div class="col-md-6 col-sm-2 col-xs-6" > 课程分类 - {{my_type}}</div>-->
...
export default {
  ...
  methods:{
    ...
    getdata:function () {
      var vm = this;
      axios({
        url:this.GLOBAL.HOST+'course/search/'+vm.currentPage+'/'+vm.cname+'/'
       // url: 'http://localhost:8000/course/getcoursebytypeid/1/'
      }).then(function (response) {
        // console.log(response.data)
        vm.list = response.data
        // vm.my_type = vm.list[0].type
    ...
    getPageSize:function(){
      var vm =this
      axios({
        url:this.GLOBAL.HOST+'course/pageacount/'+vm.cname+'/'
        // 'http://localhost:8000/course/pageacount/'+vm.cname+'/'
      })
        .then(function (response) {
          console.log(response.data)
